...
\includegraphics<2>[width = 1\textwidth]{fi.png}
\includegraphics<3>[width = 1\textwidth]{fis.png}
\includegraphics<4>[width = 1\textwidth]{all.png}
\end{figure}
\end{frame}
...
\begin{figure}
\includegraphics<1>[width = \textwidth]{morris-watermaze.jpg}
\includegraphics<2>[width = 1\textwidth]{vasilaki.png}
\includegraphics<3>[width = 8cm]{vasilaki2.png}
\end{figure}
\end{frame}
...
\begin{figure}
\includegraphics[height = 0.6\textheight]{logo.png}
\end{figure}
